...
- Ubuntu 14.01 with Python 2.7.6
...
Ubuntu support added by Stephen Pearson (thekitchenscientist at gmail dot com)
...
class ev3:
    ...
    def set_LED(self, pattern):
        ...
        pattern:  0...9
            ...
            2: Led red,
            3: Led orange,
            4: Led green flashing,
            5: Led red flashing,
            6: Led orange flashing,
            7: Led green pulse,
            8: Led red pulse,
            9: Led orange pulse,
        '''
